...
unzip("county.zip", exdir = "county_shape")

# Read the shapefile
counties <- st_read("county_shape/tl_2023_us_county.shp")
# Key columns: GEOID (5-digit), NAME, STATEFP, geometry
```
...
Change function to filter 56 (Wyoming) and below GEOID

Try to include county road, state road as right now it is just capturing road
